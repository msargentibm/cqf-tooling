...
public class ScaffoldProcessor {
    ...
    private org.opencds.cqf.utilities.IOUtils.Encoding outputEncoding;
    ...
    public void internalCreateSTU3Library(String name) {
        ...
        org.opencds.cqf.common.stu3.CqfmSoftwareSystemHelper cqfmHelper = new org.opencds.cqf.common.stu3.CqfmSoftwareSystemHelper();
        cqfmHelper.ensureSoftwareSystemExtensionAndDevice(newLibrary, softwareSystems);
    ...
    public void internalCreateR4Library(String name) {
        ...
        newLibrary.setId(name);
        newLibrary.setName(name);
        org.opencds.cqf.common.r4.CqfmSoftwareSystemHelper cqfmHelper = new org.opencds.cqf.common.r4.CqfmSoftwareSystemHelper();
        cqfmHelper.ensureSoftwareSystemExtensionAndDevice(newLibrary, softwareSystems);
    ...
    public void internalCreateSTU3Measure(String name) {
        ...
        org.opencds.cqf.common.stu3.CqfmSoftwareSystemHelper cqfmHelper = new org.opencds.cqf.common.stu3.CqfmSoftwareSystemHelper();
        cqfmHelper.ensureSoftwareSystemExtensionAndDevice(newMeasure, softwareSystems);
